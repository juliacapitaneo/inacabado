...
function setup() {
  ...
  var plane = Bodies.rectangle(100, 100, 100, 50, plane_options);
  World.add(world, plane);

  //crie corpo block1 e adicione ao mundo
  var block1_options;
  block1 = Bodies.rectangle(100, 400, 400, 20, block1_options);
  World.add(world, block1);

  //crie corpo block2 e adicione ao mundo
  var block2_options;
  block2 = Bodies.rectangle(100, 400, 400, 20, block2_options);
  ...
  rotate1 = Bodies.rectangle(100, 400, 400, 20, rotator_options);
  World.add(world, rotate1);

  //crie rotator2 e adicione ao mundo
  rotate2 = Bodies.rectangle(100, 400, 400, 20, rotator_options);
...
function draw() {
  ...
  rect(plane.position.x, plane.position.y, 0, 20);
